...
<div class="login-box">
  <div class="login-logo">
    <a href="/res/admin/index2.html"><b>Administração</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Acesse área administrativa com seu nome de USUÁRIO e SENHA</p>
    ...
    <form action="/admin/login" method="post">
      ...
      <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="senha de usuário" name="password">
